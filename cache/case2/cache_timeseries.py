...
a1=sys.argv[1]
#a2=sys.argv[2]
f=open('/home/erc/Desktop/nvsk2/papers/javascript/cache/cpu0/output'+a1+'.txt','r')
count1=1
count2=1
c=""
d=""
...
sys.stdout = open('/home/erc/Desktop/nvsk2/papers/javascript/cache/stage2test1/cpufinal/output_stage2_0.txt', 'a')
for x in f:
	#count=count+1
	#if(count<=100):
