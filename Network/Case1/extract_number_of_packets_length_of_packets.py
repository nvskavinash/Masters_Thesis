...
a1=sys.argv[1]
a2=sys.argv[2]
path = '/home/erc/Desktop/nvsk/papers/javascript/pcap/website_pcapFiles_100/test'+str(a1)+'/test_'+str(a2)+'_Chrome.pcap'
scapy_cap = rdpcap('/home/erc/Desktop/nvsk/papers/javascript/pcap/website_pcapFiles_100/test'+str(a1)+'/test_'+str(a2)+'_Chrome.pcap')
...
sys.stdout = open('/home/erc/Desktop/nvsk/papers/javascript/pcap/final/cpu100/result'+str(a2)+'.txt', 'w+')
